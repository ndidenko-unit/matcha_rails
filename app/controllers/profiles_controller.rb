class ProfilesController < ApplicationController
  ...
  def edit
    # binding.pry
    # redirect_to edit_profile_path(@profile) unless current_user.profile.id == params[:id]
  end
  ...
  private
    ...
    def profile_params
      params.require(:profile).permit(:first_name, :last_name, :age, :gender, :sex_preferences, :tags, :bio).merge(user_id: current_user.id)
    end
end
